                    ...
                    <div class="flex flex-col items-center">
                        <button
                            ...
                            <!-- <span class="ml-4">
                                ...
                                Already have an account? <a class="text-purple-600" href="login.php">Login</a>
                            </span> 
                        </button>
                    </div>
...
<form action=reg2.php method='post'>
                    <div class="mx-auto max-w-xs">
                        <input
                            class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white" name='email'
        ...
        <div class="flex-1 bg-indigo-100 text-center hidden lg:flex">
            <div class="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat"
                style="background-image:url('img/login-side-img.png');">
            </div>
        </div>
    </div>
</div>
